...
vid_writr = cv2.VideoWriter("./output4.avi",forcc,fps,(int(width),int(height)))
...
#     img1[0:rows,0:cols]=img4 # if you want to fix logo top right width-cols start
    vid_writr.write(frame)                     # if you want to fix logo botom left will start with 0 rows hight- width
    rect,frame=vid.read()                      # if you want to fix logo botom right will start with rows width-start col hight-width
vid.release()
vid_writr.release()
